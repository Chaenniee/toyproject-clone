...
2022년 2학기 세미나를 수강한 Frontend Rookie 3명, Backend Rookie 3명, 디자이너 1명이 합심한 클론 코딩 프로젝트입니다.
클론한 서비스는 서울대학교 학생들의 애증의 웹사이트, **서울대학교 eTL** 입니다.

#### 🔸 기존 웹사이트 주소

> https://myetl.snu.ac.kr/ > <br/>❗️ 본 페이지는 서울대학교 계정이 있어야 접근이 가능합니다.🥲
...
> 1. Git Clone으로 프로젝트 파일을 받아옵니다. <br/> > `git clone "https://github.com/wafflestudio20-5/team10-web.git"`
> 2. toyproject 디렉토리로 이동합니다. <br/> > `cd team10-web/toyproject`
> 3. npm이나 yarn을 이용해 실행해 줍니다. <br/> > `npm run start` or `yarn start`

### 📝 기능 명세

- 회원가입, 일반 로그인, 소셜 로그인
- 유저 계정 페이지 : 프로필 사진 등록, 비밀번호 변경
- 수강신청
- 대시보드
- 과목 별 모듈 : 모듈 접기 및 펼치기, 수업 자료 다운로드
- 과목 별 공지 게시판, Q&A 게시판 : 게시글 작성(공지는 교수 계정만 작성 가능) ・ 수정 ・ 삭제, 댓글 작성 ・ 수정 ・ 삭제
- 과목 별 수강생 : 페이지네이션
- 과목 별 과제 : 과제 세부 내용 확인, 과제 제출 및 제출물 다운로드
- 과목 별 성적 : 과제 점수 확인
- 강의 평가
- 이용 안내
...
- `신규 계정`을 생성하면 수업, 과제, 성적이 하나도 없어서 체험의 재미가 반감됩니다. 회원가입은 맛만 보시고 미리 만들어진 계정으로 로그인해 주세요!
  > `ID:` wafflekim@snu.ac.kr <br/> > `PASSWORD:` wafflekim
